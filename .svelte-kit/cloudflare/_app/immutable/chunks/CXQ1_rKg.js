...
class w {
  ...
  #r = (t) => {
    ...
    for (const [e, a] of this.#e)
      s.includes(e) || (o(a.effect), this.#e.delete(e));
  };
  ensure(t, s) {
    var e = m,
      a = b();
    ...
    if ((this.#t.set(e, t), a)) {
      for (const [r, h] of this.#s)
        r === t ? e.unskip_effect(h) : e.skip_effect(h);
      for (const [r, h] of this.#e)
        r === t ? e.unskip_effect(h.effect) : e.skip_effect(h.effect);
