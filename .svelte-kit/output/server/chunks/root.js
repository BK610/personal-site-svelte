import {
  ...
  A as ASYNC,
  v as includes,
  w as HYDRATION_START_FAILED,
  x as EFFECT_TRANSPARENT,
  y as EFFECT_PRESERVED,
  S as STALE_REACTION,
  n as noop,
  z as EAGER_EFFECT,
  F as STATE_SYMBOL,
  G as object_prototype,
  J as array_prototype,
  K as get_descriptor,
  L as get_prototype_of,
  N as is_array,
  O as is_extensible,
  P as HEAD_EFFECT,
  Q as DESTROYING,
  T as USER_EFFECT,
  V as REACTION_IS_UPDATING,
  X as index_of,
  Y as define_property,
  Z as array_from,
  _ as is_passive_event,
  $ as LEGACY_PROPS,
  a0 as render,
  a1 as setContext,
  a2 as derived,
...
class Batch {
  ...
  #process() {
    ...
    if (this.#roots.length > 0) {
      ...
      batch2.#roots.push(
        ...this.#roots.filter((r) => !batch2.#roots.includes(r)),
      );
    }
    if (next_batch !== null) {
